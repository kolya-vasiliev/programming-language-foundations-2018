...
Theorem step_deterministic :
  deterministic step.
Proof. unfold deterministic. intros.
  generalize dependent y2. induction H; intros.
  - inversion H0; try reflexivity; try solve_by_invert.  
  - inversion H0; try (solve_by_inverts 2).
    subst. erewrite IHstep; try eassumption. reflexivity. 
  - inversion H; subst. inversion H1; subst; 
    try (solve_by_inverts 2).
    erewrite IHstep; try eassumption. reflexivity.
Qed. 
